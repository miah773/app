...
<head>
        <meta charset="utf-8">
        <title>Présentation de l'institut</title>
    ...
    <body>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <a href="{{ route('about') }}" class="dropdown-item active">Présentation de l'institut</a>
        ...
        <div class="container-fluid bg-breadcrumb">
            <div class="container text-center py-5" style="max-width: 900px;">
                <h3 class="text-white display-3 mb-4">Présentation de l'institut</h1>
        ...
        <ul>
                ...
                <!-- /Level 1 -->
                    ...
                    <div class="col-lg-7" style="background: linear-gradient(rgba(255, 255, 255, .8), rgba(255, 255, 255, .8)), url({{asset('assets/img/about-img.jpg')}});">
                        <h5 class="section-about-title pe-3">A propos de l'institut </h5>
                        <p class="mb-4">L’institut préparatoire aux études d’ingénieurs de Gabés a  été  crée  en vertu du décret n°2982 du 08 Septembre 2008 </p>

                        <div class="row gy-2 gx-4 mb-4">
                            <div class="col-sm-6">
                                <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>Tutelle: Ministère de l’Enseignement Supérieur, de la Recherche Scientifique </p>
                            </div>
                            <div class="col-sm-6">
                                <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>Le Directeur : Professeur ...</p>
                            </div>
                            <div class="col-sm-6">
                                <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>Appartenance: Université de Gabés</p>
                            </div>
                            <div class="col-sm-6">
                                <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>Directeur des études vice directeur : M. .....</p>
                            </div>
                            <div class="col-sm-6">
                                <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>Le sécrétaire général : M. ....</p>
                            </div>
                        ...
                        Le cycle préparatoire dure deux ans au cours desquels l’étudiant recoit une formation dans l’une des trois filières suivantes ( Maths-physique, physique-chimie ,technologie et biologie-géologie).</p>
                        <h2 class="mb-0">La formation est assurée en deux années par :</h2>
                        <p class="mb-4">
** Des enseignants et enseignants-chercheurs très engagés dans leur travail et soucieux d'accompagner au mieux les étudiants dans la préparation du concours d'accès aux écoles d'ingénieurs.<br>
** Des enseignants agrégés et des enseignants du secondaire expérimentés et connus par  leur compétences pédagogique et scientifique.<br>
** Des enseignants vacataires issus d'institutions universitaires avoisinantes.
 </p>
 <h2 class="mb-0">Départements :</h2>
 <p class="mb-4">
L’IPEI de Gabés compte plus de 60 enseignants permanents toute spécialité confondue avec différents grades de l’enseignement supérieur :maitre de conférences, maitre assistant, enseignant agrégé et assistant en plus d’enseignants du corps inter départemental pour la langue anglaise et l’informatique.
Ce staff d’enseignants est reparti sur trois départements :<br>
** Département de maths-physique ; directeur :.....<br>
** Département physique-chimie;directeur : .......<br>
** Département de technologie ;directeur :.......
 </p>
 <p class="mb-4">C'est dans cette optique que l'institut offre aux différents acteurs les meilleures conditions de travail pour accroitre leur niveau de connaissances dans différents champs disciplinaires, scientifiques et de les doter d'une solide formation en langues étrangères à fin de les rendre aptes à suivre une formation dans les écoles d'ingénieurs. Grâce à une équipe d'enseignants et d'administratifs  aussi unie que dynamique, l'IPEIGB a la ferme volonté de réussir sa mission  face à l'évolution rapide  des sciences et de la technologie.</p>
