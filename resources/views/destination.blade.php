                            ...
                            <div class="row g-4">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="destination-img">
                                                ...
                                                <div class="search-icon">
                                                    <a href="{{asset('assets/img/destination-1.jpg')}}" data-lightbox="destination-1"><i class="fa fa-plus-square fa-1x btn btn-light btn-lg-square text-primary"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="destination-img">
                                                ...
                                                <div class="search-icon">
                                                    <a href="{{asset('assets/img/destination-2.jpg')}}" data-lightbox="destination-2"><i class="fa fa-plus-square fa-1x btn btn-light btn-lg-square text-primary"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="destination-img">
                                                ...
                                                <div class="search-icon">
                                                    <a href="{{asset('assets/img/destination-7.jpg')}}" data-lightbox="destination-7"><i class="fa fa-plus-square fa-1x btn btn-light btn-lg-square text-primary"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="destination-img">
                                                ...
                                                <div class="search-icon">
                                                    <a href="{{asset('assets/img/destination-8.jpg')}}" data-lightbox="destination-8"><i class="fa fa-plus-square fa-1x btn btn-light btn-lg-square text-primary"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-4">
                                    <div class="destination-img h-100">
                                        ...
                                        <div class="search-icon">
                                            <a href="{{asset('assets/img/destination-9.jpg')}}" data-lightbox="destination-4"><i class="fa fa-plus-square fa-1x btn btn-light btn-lg-square text-primary"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="destination-img">
                                        ...
                                        <div class="search-icon">
                                            <a href="{{asset('assets/img/destination-4.jpg')}}" data-lightbox="destination-4"><i class="fa fa-plus-square fa-1x btn btn-light btn-lg-square text-primary"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
